...
describe('CaixaDaLanchonete', () => {
    ...
    //Testes extras que criei
    test.each([
        ['dinheiro', 'Item inválido!', ['cafe1']],//Teste sem a vírgula separando o nome da quantidade
        ['credito', 'Item inválido!', ['cafe1']],
        ['debito', 'Item inválido!', ['cafe1']]
    ])('Qando não possuir vírgula separando o pedido da quantidade, usando o método de pagamento em %p deve resultar em %p', validaTeste);
});
